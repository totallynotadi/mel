...
spotify = spotipy.Spotify(
                client_credentials_manager=SpotifyClientCredentials('6b8eb89b95414a56a1c97dad45d9c587', 
                                                                    '6747fd4c5e294ec685e850cf0e6dcc6e'))
    ...
    def __init__(self, name=None, track_id=None):
        ...
        for attribute in [name, track_id]:
            if attribute is not None:
                self.__type  = [key for key, value in locals().items() if value == attribute][0]
